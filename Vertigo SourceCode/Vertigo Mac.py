...
#Load Files
cloud01=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cloud01.png")).convert_alpha()
cloud02=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cloud02.png")).convert_alpha()
cloud03=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cloud03.png")).convert_alpha()
cloud04=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cloud04.png")).convert_alpha()
cloud05=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cloud05.png")).convert_alpha()
cloud06=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cloud06.png")).convert_alpha()
cloud07=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cloud07.png")).convert_alpha()
dustfx=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/dust.png")).convert_alpha()
brightfx=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/bright.png")).convert_alpha()
sparkfx=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/spark.png")).convert_alpha()
scrapfx=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/scrap.png")).convert_alpha()
bloodimg=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/blood.png")).convert_alpha()
bloodpart=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/bloodpart.png")).convert_alpha()
shieldimg=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/shield.png")).convert_alpha()

tileset=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/tileset.png")).convert_alpha()
sky=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/sky.png")).convert_alpha()
ground=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/ground.png")).convert_alpha()
grass=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/grass.png")).convert_alpha()

copterblack=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/helicopter1.png")).convert_alpha()
copterwhite=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/helicopter2.png")).convert_alpha()
coptercrash=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/helicoptercrash.png")).convert_alpha()

buildings=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/buildings.png")).convert_alpha()
glassCracked=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/cracked.png")).convert_alpha()
fireimg=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/fire.png")).convert_alpha()
shard=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/shard.png")).convert_alpha()
bulletspark=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/bulletspark.png")).convert_alpha()
bomb1=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/bomb1.png")).convert_alpha()
bombexploded=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/bombexploded.png")).convert_alpha()

vertigologo=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/vertigologo.png")).convert_alpha()
blackimg=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/black.png")).convert()
sidebar=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/sidebar.png")).convert_alpha()
arrowleft=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/arrowleft.png")).convert_alpha()
arrowright=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/arrowright.png")).convert_alpha()
arrowleft_bright=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/arrowleft_bright.png")).convert_alpha()
arrowright_bright=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/arrowright_bright.png")).convert_alpha()
level1=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level1.png")).convert_alpha()
level2=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level2.png")).convert_alpha()
level3=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level3.png")).convert_alpha()
level4=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level4.png")).convert_alpha()
level5=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level5.png")).convert_alpha()
level6=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level6.png")).convert_alpha()
level7=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level7.png")).convert_alpha()
level8=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level8.png")).convert_alpha()
level8b=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level8b.png")).convert_alpha()
level9=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level9.png")).convert_alpha()
level10=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/level10.png")).convert_alpha()
pausedimg=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/paused.png")).convert_alpha()
button=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/button.png")).convert_alpha()
keyboard=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/keyboardoverlay.png")).convert_alpha()
iconimg=pygame.image.load(os.path.abspath("/Volumes/Vertigo/Images/iconguy.png")).convert_alpha()
pygame.display.set_icon(iconimg)

gunsound=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/gunsound.wav"))
gunsound.set_volume(.15)
wind=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/wind.wav"))
wind.set_volume(.15)
machinegun=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/machinegun.wav"))
machinegun.set_volume(.25)
pain1=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/pain1.wav"))
pain1.set_volume(.3)
glassbreak=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/glassbreak.wav"))
glassbreak.set_volume(3)
explosion=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/explosion.wav"))
explosion.set_volume(.7)
coptersound=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/coptersound.wav"))
coptersound.set_volume(.2)
firesound=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/firesound.wav"))
firesound.set_volume(.05)
hitsound=pygame.mixer.Sound(os.path.abspath("/Volumes/Vertigo/Images/hitsound.wav"))
            ...
            for nn in range(12): #Shooting Helicopters
                if (copter[nn]!=""):
                    if (bulletx[n]>copterx[nn]+2 and bulletx[n]<copterx[nn]+4 and bullety[n]>coptery[nn]-1 and bullety[n]<coptery[nn]+1):
                        bullet[n]=False
                        if (copter[nn]!="Crash"): damage[nn]=damage[nn]+5; hitsound.play()
            for nn in range(10):
                                ...
                                if (bulletx[n]>=buildingx[nn]-abs(bulletdx[n]/2) and bulletx[n]<=buildingx[nn]+abs(bulletdx[n]/2)):
                                    ...
                                    if (glassLeft[nn][m]>0 or d==1):
                                        ...
                                        if (glassLeft[nn][m]<=0 and d==0):
                                            ...
                                            glassLeft[nn][m]=0; createShards(buildingx[nn],-m*36.0-20); glassbreak.play()
                                    ...
                                    if (glassRight[nn][m]>0 or d==1):
                                        ...
                                        if (glassRight[nn][m]<=0 and d==0):
                                            for mmm in range(10):
                                                if (buildingx[nn]==buildingx[mmm]):
                                                    if (bullety[n]<=(-buildingfloor1[mmm]*36.0+16)/16 and bullety[n]>=(-buildingfloor1[mmm]*36.0+16-38)/16): bullet[n]=True; break
                                            glassRight[nn][m]=0; createShards(buildingx[nn]+buildingwidth[nn]*38.0/16,-m*36.0-20); glassbreak.play()
                                            if (leveltype[level]=="Shatter"): levelvar2[level]+=1
                    ...
                    if (bulletx[n]>=npcx[nn]-1 and bulletx[n]<=npcx[nn]+abs(bulletdx[n])+.3 and bullety[n]>npcy[nn]-.5 and bullety[n]<npcy[nn]+1.2):
                        ...
                        if (bulletenemy[n]>=1 and npc[nn]==npc[camera] and invinsible<=0 and stance<0 and fade<100): #Player Shot
                            if (shield==1 and shootDelay[camera]<=18):
                                if (bulletx[n]>npcx[camera]+.6-bulletdx[n]*2 and shielddir==1): bullet[n]=False; hitsound.play()
                                if (bulletx[n]<npcx[camera]+.6-bulletdx[n] and shielddir==0): bullet[n]=False; hitsound.play()
                            if (bullet[n]==True):
                                bullet[n]=False
...
def displayCopters():
    ...
    for n in range(12):
        ...
        if (copter[n]!=""): #Copter Movement
            ...
            if (n==0):
                if (engine[n]>.3):
                    if (coptersoundplay==0): coptersound.play(-1); coptersoundplay=1
                if (engine[n]<=.3):
                    if (coptersoundplay==1): coptersound.stop(); coptersoundplay=0
...
def displayNPCs():
    ...
    for n in range(12):
        if (npc[n]=="Ally" and stance==-1):
            if (npcalive[n]==0 and alive==1): alive=0; pain1.play()
                ...
                if (npcalive[n]==1 and npcy[n]>npcy[camera]-d and npcy[n]<npcy[camera]+d):
                    ...
                    if (shootDelay[n]<=0 and npcx[camera]>npcx[n]-d and npcx[camera]<npcx[n]+d and fade<100): #NPCs Shooting
                      ...
                      if (f==1):
                        ...
                        if (npcx[n]<npcx[camera]+10 and npcx[n]>npcx[camera]-10): createBullets(npcx[n]+.4,npcy[n]+.5,npcx[camera]+.4+random.randint(-5,5)/10.0,npcy[camera]+.5+random.randint(-5,5)/10.0); gunsound.play()
                        else: createBullets(npcx[n]+.4,npcy[n]+.5,npcx[camera]+.4+random.randint(-20,20)/10,npcy[camera]+.5+random.randint(-20,20)/10.0); gunsound.play()
...
def displayPaused():
    ...
    if (paused==1):
        if (controlshow==0):
            ...
            screen.blit(text,(WIDTH/2-25,HEIGHT/2-125+10))
            ...
            screen.blit(text,(WIDTH/2-38,HEIGHT/2-125+70))
            ...
            screen.blit(text,(WIDTH/2-20,HEIGHT/2-125+100))
    ...
    for event in pygame.event.get():
        ...
        if (mainmenu==0):
            if (((event.type==pygame.MOUSEBUTTONDOWN and event.button==1) or (spacefire==1 and stance>=0)) and stance==-1 and alive==1 and paused==0 and shootDelay[camera]<=0): #Using Weapons
                if (mx<npcx[camera]*16+WIDTH/2-camerax*16 and fade<100): createBullets(npcx[camera]+1,npcy[camera]+.5,mx/16.0+camerax-WIDTH/2/16.0,my/16.0+cameray-HEIGHT/2/16.0); shootDelay[camera]=30; firstshot=1; gunsound.play()
                if (mx>npcx[camera]*16+WIDTH/2-camerax*16 and fade<100): createBullets(npcx[camera],npcy[camera]+.5,mx/16.0+camerax-WIDTH/2/16.0,my/16.0+cameray-HEIGHT/2/16.0); shootDelay[camera]=30; firstshot=1; gunsound.play()
            if (spacefire==1 and stance==-1 and shootDelay[camera]<=0 and paused==0 and alive==1):
                if (lastdir==1): spacefire=0; createBullets(npcx[camera]+1,npcy[camera]+.5,npcx[camera],npcy[camera]+.5); shootDelay[camera]=30; firstshot=1; gunsound.play()
                if (lastdir==0): spacefire=0; createBullets(npcx[camera],npcy[camera]+.5,npcx[camera]+1,npcy[camera]+.5); shootDelay[camera]=30; firstshot=1; gunsound.play()
