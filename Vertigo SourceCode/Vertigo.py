...
gunsound=pygame.mixer.Sound("Images/gunsound.wav")
gunsound.set_volume(.15)
wind=pygame.mixer.Sound("Images/wind.wav")
wind.set_volume(.15)
machinegun=pygame.mixer.Sound("Images/machinegun.wav")
machinegun.set_volume(.25)
pain1=pygame.mixer.Sound("Images/pain1.wav")
pain1.set_volume(.3)
glassbreak=pygame.mixer.Sound("Images/glassbreak.wav")
glassbreak.set_volume(3)
explosion=pygame.mixer.Sound("Images/explosion.wav")
explosion.set_volume(.7)
coptersound=pygame.mixer.Sound("Images/coptersound.wav")
coptersound.set_volume(.2)
firesound=pygame.mixer.Sound("Images/firesound.wav")
firesound.set_volume(.05)
hitsound=pygame.mixer.Sound("Images/hitsound.wav")
